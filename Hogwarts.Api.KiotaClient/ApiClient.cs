...
namespace ApiSdk
{
    ...
    public partial class ApiClient : BaseRequestBuilder
    {
        ...
        public global::ApiSdk.Students.StudentsRequestBuilder Students
        {
            get => new global::ApiSdk.Students.StudentsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        ...
        public ApiClient(IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}", new Dictionary<string, object>())
        {
            ...
            {
                RequestAdapter.BaseUrl = "http://localhost:5280";
            }
